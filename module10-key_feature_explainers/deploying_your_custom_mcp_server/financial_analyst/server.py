"""Financial Analyst MCP Server - Provides stock analysis tools via Model Context Protocol."""
...
def analyze_stock(query: str) -> str:
    """
    Analyzes stock market data based on the query and generates executable Python code 
    for analysis and visualization. Returns a formatted Python script ready for execution.
...
def save_code(code: str) -> str:
    ...
    Save the given code to a file stock_analysis.py, make sure the code is a valid python file, 
    nicely formatted and ready to execute.
